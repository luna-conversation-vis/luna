...
class LineChart(AltairChart):
    ...
    def initialize_chart(self):
        ...
        if y_attr.data_model == "measure":
            ...
            x_attr_field_code = f"alt.X('{x_attr.attribute}', axis=alt.Axis(title='{x_attr_abv}'))"
            y_attr_field_code = f"alt.Y('{y_attr.attribute}', title='{agg_title}', axis=alt.Axis(title='{y_attr_abv}'))"
        else:
            ...
            x_attr_field_code = f"alt.X('{x_attr.attribute}', title='{agg_title}', axis=alt.Axis(title='{x_attr_abv}'))"
            y_attr_field_code = f"alt.Y('{y_attr.attribute}', axis=alt.Axis(title='{y_attr_abv}'))"
